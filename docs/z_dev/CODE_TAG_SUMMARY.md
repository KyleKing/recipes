...
- appveyor.yml
    - line  49 PLANNED: Figure out why the .venv isn't being cached
...
- docs/z_dev/README.md
    - line  14    TODO: Update with changes from calcipy! -->
    - line  33    TODO: Update with changes from calcipy! -->

- noxfile.py
    - line  42 PLANNED: Make an environment to check the built wheel file for imports once most are optional:
    - line  44 PLANNED: Add environment for safety, see https://github.com/KyleKing/calcipy/issues/32 for snippet

- recipes/formatter.py
    - line  71    TODO: Capture image -->'  # noqa: T101
    - line 281   FIXME: Read from copier template

Found code tags for FIXME (1), TODO (90), PLANNED (4), FYI (1), NOTE (2)
