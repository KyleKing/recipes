...
- appveyor.yml
    - line  93 PLANNED: Specify single files, like wheels, but zip the docs/reports
...
- pyproject.toml
    - line  64    HACK: will be in calcipy 0.2.1
    - line  71    HACK: will be in calcipy 0.2.1

- recipes/formatter.py
    - line  73    TODO: Capture image -->'  # noqa: T101
    - line 283   FIXME: Read from copier template

Found code tags for FIXME (1), TODO (89), PLANNED (1), HACK (2), NOTE (2)
